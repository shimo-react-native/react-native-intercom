...
class IntercomClient {
  ...
  Notifications = Platform.OS === 'ios' ? {
    ...
    WINDOW_WILL_SHOW: IntercomEventEmitter.WINDOW_WILL_SHOW_NOTIFICATION,
    WINDOW_DID_SHOW: IntercomEventEmitter.WINDOW_DID_SHOW_NOTIFICATION,
    WINDOW_WILL_HIDE: IntercomEventEmitter.WINDOW_WILL_HIDE_NOTIFICATION,
    WINDOW_DID_HIDE: IntercomEventEmitter.WINDOW_DID_HIDE_NOTIFICATION,
    DID_START_NEW_CONVERSATION: IntercomEventEmitter.DID_START_NEW_CONVERSATION_NOTIFICATION
  } : {
    UNREAD_COUNT: IntercomEventEmitter.UNREAD_CHANGE_NOTIFICATION,
    WINDOW_DID_SHOW: IntercomEventEmitter.WINDOW_DID_SHOW_NOTIFICATION,
    WINDOW_DID_HIDE: IntercomEventEmitter.WINDOW_DID_HIDE_NOTIFICATION
  ...
  constructor() {
    this._eventHandlers = Platform.OS === 'ios' ? {
      [IntercomEventEmitter.UNREAD_CHANGE_NOTIFICATION]: new Map(),
      [IntercomEventEmitter.WINDOW_WILL_SHOW_NOTIFICATION]: new Map(),
      [IntercomEventEmitter.WINDOW_DID_SHOW_NOTIFICATION]: new Map(),
      [IntercomEventEmitter.WINDOW_WILL_HIDE_NOTIFICATION]: new Map(),
      [IntercomEventEmitter.WINDOW_DID_HIDE_NOTIFICATION]: new Map(),
      [IntercomEventEmitter.DID_START_NEW_CONVERSATION_NOTIFICATION]: new Map()
    } : {
      [IntercomEventEmitter.UNREAD_CHANGE_NOTIFICATION]: new Map(),
      [IntercomEventEmitter.WINDOW_DID_SHOW_NOTIFICATION]: new Map(),
      [IntercomEventEmitter.WINDOW_DID_HIDE_NOTIFICATION]: new Map()
  ...
  addEventListener(type, handler) {
    ...
    if ( Platform.OS === 'android' && !this._registeredListener
      && (type === this.Notifications.WINDOW_DID_SHOW || type === this.Notifications.WINDOW_DID_HIDE)) {
      IntercomEventEmitter.registerShowingListener();
    }
